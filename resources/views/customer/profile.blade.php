                            ...
                            <div class="card bg-secondary shadow">
                                <div class="card-header bg-white border-0">
                                    <div class="card-body col-12">
                                        ...
                                        @if(isset($userprof))
                                            <form action="{{route('custstore')}}" method="post">
                                                ...
                                                @endif
                                                @if(isset($userprof))
                                                    <input id="id" type="text" name="id" value="{{$userprof->id}}"
                                                           hidden>
                                                @endif
                                    ...
                                    <strong>{{ $errors->first('email') }}</strong>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                @else
                                                                    <input id="input-fname"
                                                                           class="form-control{{ $errors->has('fname') ? ' is-invalid' : '' }}"
                                                                           placeholder="First Name" name="fname"
                                                                           value="{{ $userprof->fName }}" type="text"
                                                                           required
                                                                           autofocus>
                                                                    @if ($errors->has('fname'))
                                                                        <span class="invalid-feedback" role="alert">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                @else
                                                                    <input id="input-mname"
                                                                           class="form-control{{ $errors->has('mname') ? ' is-invalid' : '' }}"
                                                                           placeholder="Middle Name" name="mname"
                                                                           value="{{ $userprof->mName }}" type="text"
                                                                           required
                                                                           autofocus>
                                                                    @if ($errors->has('mname'))
                                                                        <span class="invalid-feedback" role="alert">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                @else
                                                                    <input id="input-lname"
                                                                           class="form-control{{ $errors->has('lname') ? ' is-invalid' : '' }}"
                                                                           placeholder="Last Name" name="lname"
                                                                           value="{{ $userprof->lName }}" type="text"
                                                                           required
                                                                           autofocus>
                                                                    @if ($errors->has('lname'))
                                                                        <span class="invalid-feedback" role="alert">
                                                ...
                                                <hr class="my-4"/>
                                                <h6 style="color:black;font-size:medium" class="heading-small mb-4">
                                                    Address</h6>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                @if(isset($user))
                                                                    <input id="input-town" type="text"
                                                                           ...
                                                                           placeholder="Town" required>
                                                                @else
                                                                    <select class="form-control" id="input-branch"
                                                                            name="branch">
