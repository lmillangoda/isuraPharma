  ...
  @endif
    ...
    <div class="pl-lg-4"> 
      ...
      <div class="form-group">
        <center><label style = "color:black;" class="form-control-label" for = "branName">Brand Name</label></center>
      ...
      <div class = "col-6">
      <div class="form-group">
          <center><label style = "color:black;" class="form-control-label" for = "medicalName">Medical Name</label></center>
    ...
    <div class="pl-lg-4"> 
      ...
      <div class = "col-6">
      <div class="form-group">
          <center><label style = "color:black;" class="form-control-label" for = "price">Unit Price</label></center>
        <input class="form-control" type="text" name="price" value="{{isset($product->price) ? $product->price : null}}" placeholder="10">
      </div>
    </div>
    <div class = "col-6">
      <div class="form-group">
          <center><label style = "color:black;" class="form-control-label" for = "buying_price">Buying Price</label></center>
    ...
    <div class="pl-lg-4"> 
      ...
      <div style = "color:black;" class="form-control-label">
          <center><label style = "color:black;" class="form-control-label" for="reorder_level">Reorder Level</label></center>
    ...
    <div class="container col-8">
     <div class="card bg-secondary">
      <div class="card-body col-12">
      <div class="pl-lg-4">
      <label style = "color:black;" class="form-control-label" for="suppliers">Suppliers</label>
