                            ...
                            <div class="pl-lg-4">
                              ...
                              <div class="pl-lg-4">
                                ...
                                <div class = "row justify-content-center">
                                  ...
                                  <div class="col-md-4">
                                      <div class="modal fade" id="modal-form" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true"> <!-- Password change modal -->
                                            ...
                                            <div class="modal-body p-0">
                                              <div class="card bg-secondary shadow border-0">
                                                <div class="card-body px-lg-5 py-lg-5">
                                                  ...
                                                  <form role="form" method = "post" action ="{{route('cPassword')}}" enctype="multipart/form-data">
                                                    @csrf
                                                      <div class="form-group">
                                                          <div class="input-group input-group-alternative">
                                                            ...
                                                            <input class="form-control{{ $errors->has('old_password') ? ' is-invalid' : '' }}" name="old_password" placeholder="Old Password" type="password" required autofocus>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group input-group-alternative">
                                                              ...
                                                              <input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="New Password" type="password" required autofocus>
                                                    ...
                                                    <div class="form-group">
                                                      <div class="input-group input-group-alternative">
                                                        ...
                                                        <input class="form-control" placeholder="New Password Confirmation" name="password_confirmation" type="password" required autofocus>
                                                      </div>
                                                    </div>
