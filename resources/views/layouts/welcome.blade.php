        ...
        <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active">
                    <div class="carousel-background"><img src="{{URL::asset('assets_w/img/intro-carousel/1.jpg')}}"
                                                          alt=""></div>
                ...
                <div class="carousel-item">
                    <div class="carousel-background"><img src="{{URL::asset('assets_w/img/intro-carousel/2.jpg')}}"
                                                          alt=""></div>
                    <div class="carousel-container">
                        <div class="carousel-content">
                ...
                <div class="carousel-item">
                    <div class="carousel-background"><img src="{{URL::asset('assets_w/img/intro-carousel/3.jpg')}}"
                                                          alt=""></div>
                    <div class="carousel-container">
                        <div class="carousel-content">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 footer-info">
                    ...
                    <p>Find the best Pharmacetical & cosmetic products at our branches. A friendly and proffesional
                        Staff to meet all your every needs</p><br>
