                ...
                <div class="col-lg-4 col-sm-6 portfolio-item">
                    <div class="alert alert-default" role="alert">
                        ...
                        <a class="btn btn-sm btn-danger"
                           href="{{route('products.show',['product'=>$warnings[$i]['product']])}}">View Suppliers</a>
                        <a class="btn btn-sm btn-danger"
                           href="{{route('backup_stock.create',['product'=>$warnings[$i]['product'], 'branch'=>$warnings[$i]['branch']])}}">Update
                            Backup Stocks</a>
                    </div>
                </div>
            @endfor
