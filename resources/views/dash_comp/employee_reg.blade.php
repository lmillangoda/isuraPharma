    ...
    <div class="col-10">
        ...
        <div class="card-body">
            ...
            @endif
                ...
                <h6 style = "color:black;font-size:medium" class="heading-small mb-4">Basic Info</h6>
                @if(isset($employee))
                ...
                <div class="pl-lg-4">   
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label style = "color:black;" class="form-control-label" for="input-fname">First Name</label>
                           
                            @if(isset($employee))
                            <input id="input-fname" class="form-control{{ $errors->has('fname') ? ' is-invalid' : '' }}" placeholder ="First Name" name="fname" value="{{ $employee->fName }}" type="text" required autofocus>
                            @else
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label style = "color:black;" class="form-control-label" for="input-mname">Middle Name</label>
                         
                            @if(isset($employee))
                            <input id="input-mname" class="form-control{{ $errors->has('mname') ? ' is-invalid' : '' }}" placeholder ="Middle Name" name="mname" value="{{ $employee->mName }}" type="text" required autofocus>
                            @else
                    ...
                    <div class="row">
                        <div class="col-md-6">
                        <div class="form-group">
                            <label style = "color:black;" class="form-control-label" for="input-lname">Last Name</label>
                            @if(isset($employee))
                            <input id="input-lname" class="form-control{{ $errors->has('lname') ? ' is-invalid' : '' }}" placeholder ="Last Name" name="lname" value="{{ $employee->lName }}" type="text" required autofocus>
                            @else
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label style = "color:black;" class="form-control-label" for="input-tel">Telephone NO</label>
                                
                                @if(isset($employee))
                                <input id="input-tel" class="form-control{{ $errors->has('tel') ? ' is-invalid' : '' }}" placeholder ="Telephone NO" name="tel" value="{{ $employee->tel }}" type="text" required autofocus>
                                @else
                    ...
                    <div class="pl-lg-4">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label style = "color:black;" class="form-control-label" for="input-hno">Home Address NO</label>
                                
                                @if(isset($employee))
                                <input id="input-hno" class="form-control{{ $errors->has('hno') ? ' is-invalid' : '' }}" placeholder ="Home Address NO" name="hno" value="{{ $employee->hNo }}" type="text" required autofocus>
                                @else
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label style = "color:black;" class="form-control-label" for="input-line1">Address Line 1</label>
                               
                                @if(isset($employee))
                                <input id="input-line1" class="form-control{{ $errors->has('line1') ? ' is-invalid' : '' }}" placeholder ="Line 1" name="line1" value="{{ $employee->add1 }}" type="text" required autofocus>
                                @else
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label style = "color:black;" class="form-control-label" for="input-line2">Address Line 2</label>
                                
                                @if(isset($employee))
                                <input id="input-line2" class="form-control{{ $errors->has('line2') ? ' is-invalid' : '' }}" placeholder ="Line 2" name="line2" value="{{ $employee->add2}}" type="text" required autofocus>
                                @else
                        ...
                        <div class="row">
                                <div class="col-lg-12">
                                <div class="form-group">
                                    <label style = "color:black;" class="form-control-label" for="input-town">Town</label>
                                  
                                    @if(isset($employee))
                                    <input id="input-town" type="town" class="form-control{{ $errors->has('town') ? ' is-invalid' : '' }}" name="town" value="{{ $employee->town }}" placeholder ="Town" required>
                                    @else
                    ...
                    <div class="pl-lg-4">
                        <div class="row">
                            <div class="col-lg-6">
                            <div class="form-group">
                                <label style = "color:black;" class="form-control-label" for="input-password">Password</label>
                            ...
                            <div class="col-lg-6">
                            <div class="form-group">
                                <label style = "color:black;" class="form-control-label" for="input-password-confirm">Confirm Password</label>
                    ...
                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label style = "color:black;" class="form-control-label" for="input-branch">Branch</label>
