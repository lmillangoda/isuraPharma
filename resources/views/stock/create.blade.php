                    ...
                    <div id="stock" class="">
                        ...
                        <form id="form" class="form" action="#" method="post">
                            ...
                            <button form="form" class="btn btn-primary"
                                    formaction="{{action('StockController@update',['branch_id'=>$branch, 'product_id'=>$product])}}"
                                    formenctype="multipart/form-data" formmethod="post" type="submit" name="addBtn">Add
                                to Stock
                            </button>
                            <button form="form" class="btn btn-warning"
                                    formaction="{{action('StockController@substract',['branch_id'=>$branch, 'product_id'=>$product])}}"
                                    formenctype="multipart/form-data" formmethod="post" type="submit" name="subBtn">
                                Substract from Stock
                            </button>
                        </form>
                        <form class="delete"
                              action="{{route('stock.delete',['branch_id'=>$branch, 'product_id'=>$product])}}"
                              method="post">
                            @csrf
                            @method('delete')
